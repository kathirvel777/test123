...
+ (void)initialize {
    ...
    {
        checkedIcon = [UIImage imageNamed:@"31-tick" inBundle:[NSBundle bundleForClass:[OLFacebookImagePickerCell class]] compatibleWithTraitCollection:nil];
    }
    else
    {
        checkedIcon = [UIImage imageNamed:@"31-tick"];
    }
}
