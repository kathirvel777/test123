...
@interface WizardMyVideos ()<GADBannerViewDelegate>
{
    NSString *user_id;
    MBProgressHUD *hud;
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(wizardVid:)
                                                 name:@"wizardVid" object:nil];
    
}

-(void)viewDidLayoutSubviews
{
    self.secondView.frame = CGRectMake(0,  self.tabBarController.tabBar.frame.origin.y-15, self.secondView.frame.size.width, self.secondView.frame.size.height - self.tabBarController.tabBar.frame.origin.y + self.tabBarController.tabBar.frame.size.height);
}
...
- (void)wizardVid:(NSNotification *)note
{
    hud=[MBProgressHUD showHUDAddedTo:self.view animated:YES];
    ...
    [[NSUserDefaults standardUserDefaults] setObject:dataSave forKey:@"wizardGalleryVid"];
    
    [[NSUserDefaults standardUserDefaults] synchronize];
    
    //To get userdefault array value in workspace view controller
    [[NSNotificationCenter defaultCenter] postNotificationName:@"wizardVideo" object:nil];
