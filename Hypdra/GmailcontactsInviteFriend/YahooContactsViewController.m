...
@interface YahooContactsViewController ()<UISearchBarDelegate,ClickDelegates>
{
...
@implementation YahooContactsViewController
...
- (void)viewDidLoad
{
    ...
    NSString *currentURL=[NSString stringWithFormat:@"https://www.hypdra.com/YahoAPI/ReturnYahoo.php?User_ID=%@&ServiceType=%@",user_id,_inviteFor];
...
-(void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    ...
    [popUp initAlertwithParent:self withDelegate:self withMsg:@"Some internal error to load webview" withTitle:@"Try Again" withImage:[UIImage imageNamed:@"Alert_icon.png"]];
...
-(void)getGmailResponse
{
    @try
    {
        NSDictionary *parameters =@{@"User_ID":user_id,@"EmailDomain":@"yahoo",@"lang":@"iOS"};
