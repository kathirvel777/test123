...
@interface GmailContactsViewController ()<UISearchBarDelegate,ClickDelegates>
{
...
@implementation GmailContactsViewController
...
- (void)viewDidLoad
{
    ...
    NSString *currentURL=[NSString stringWithFormat:@"https://www.hypdra.com/googleapi/ReturnGoogle.php?User_ID=%@&ServiceType=%@",user_id,_inviteFor];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView
{
    ...
    {
        //today
        if([[[[webView request]URL]absoluteString]containsString:@"contacts"])
        {
...
-(void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    ...
    else
    {
        ...
        [popUp initAlertwithParent:self withDelegate:self withMsg:@"Could not connect to server to load webview" withTitle:@"Info" withImage:[UIImage imageNamed:@"Alert_icon.png"]];
...
-(void)getGmailResponse
{
    @try
    {
        NSDictionary *parameters =@{@"User_ID":user_id,@"EmailDomain":@"gmail",@"lang":@"iOS"};
        ...
        [[manager dataTaskWithRequest:req uploadProgress:nil downloadProgress:nil completionHandler:^(NSURLResponse * _Nonnull response, id  _Nullable responseObject, NSError * _Nullable error)
          {
              ...
              {
                  CustomPopUp *popUp = [CustomPopUp new];
                  [popUp initAlertwithParent:self withDelegate:self withMsg:@"Could not connect to server " withTitle:@"Info" withImage:[UIImage imageNamed:@"Alert_icon.png"]];
...

{
    ...
    @try
    {
        ...
        else
        {
            ...
            CustomPopUp *popUp = [CustomPopUp new];
            [popUp initAlertwithParent:self withDelegate:self withMsg:@"select atleast one" withTitle:@"Info" withImage:[UIImage imageNamed:@"Alert_icon.png"]];
