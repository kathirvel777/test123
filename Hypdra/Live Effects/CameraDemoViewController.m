...
@interface CameraDemoViewController() <CGEFrameProcessingDelegate,ClickDelegates>
{
...
@property (nonatomic,strong)NSMutableArray *sapphireTags,*bisterTags,*oscillateTags,*mulberryTags,*mantleTags,*flourishTags,*idleTags,*auricTags,*opaqueTags;
...
- (void)viewDidLoad
{
    ...
    self.intensitySliders.tintColor=UIColorFromRGB(0xFFED61);
        ...
        _sapphireTags=[[NSMutableArray alloc]init];
        _bisterTags=[[NSMutableArray alloc]init];
        _oscillateTags=[[NSMutableArray alloc]init];
        _mulberryTags=[[NSMutableArray alloc]init];
        _mantleTags=[[NSMutableArray alloc]init];
        _flourishTags=[[NSMutableArray alloc]init];
        _idleTags=[[NSMutableArray alloc]init];
        _auricTags=[[NSMutableArray alloc]init];
        _opaqueTags=[[NSMutableArray alloc]init];
       ...
       self.categoryNames = [NSMutableArray arrayWithObjects:@"SAPPHIRE", @"BISTER",@"OSCILLATE",@"MULBERRY",@"MANTLE",@"FLOURISH",@"IDLE",@"AURIC",@"OPAQUE",nil];
        ...
        self.sapphireTags=[NSMutableArray arrayWithObjects:@"106",@"69",@"75",@"70",@"82",@"68",@"43",@"42",@"30" ,nil];
        
        self.bisterTags=[NSMutableArray arrayWithObjects:@"50",@"80",@"22",@"105",@"81",@"79",@"1",@"101",@"39",@"77",nil];
        
        self.oscillateTags=[NSMutableArray arrayWithObjects:@"15",@"10",@"108",@"14",@"13",@"11",@"9",@"12",@"64",@"21",nil];
        
        self.mulberryTags=[NSMutableArray arrayWithObjects:@"104",@"5",@"47",@"74",@"49",@"66",@"44",@"41",@"53",@"57",nil];
        
        self.mantleTags=[NSMutableArray arrayWithObjects:@"18",@"16",@"36",@"20",@"26",@"110",@"24",@"17",@"19",@"107",nil];
        
        self.flourishTags=[NSMutableArray arrayWithObjects:@"29",@"38",@"65",@"67",@"76",@"46",@"7",@"71",@"48",nil];
        
        self.idleTags=[NSMutableArray arrayWithObjects:@"85",@"3",@"103",@"109",@"84",@"28",@"35",@"25",@"23",@"86",nil];
        
        self.auricTags=[NSMutableArray arrayWithObjects:@"2",@"34",@"91",@"73",@"40",@"99",@"37",@"45",@"4",@"33",nil];
        
        self.opaqueTags=[NSMutableArray arrayWithObjects:@"8",@"95",@"97",@"89",@"58",@"72",@"31",@"27",@"63",@"33",nil];
        
    
        [[self.takePic imageView] setContentMode: UIViewContentModeScaleAspectFit];
...
//            [alert show];
            ...
            [popUp initAlertwithParent:self withDelegate:self withMsg:@"The Camera Is Not Allowed!" withTitle:@"Alert" withImage:[UIImage imageNamed:@"Alert_icon.png"]];
...
//        [self.view insertSubview:_glkView belowSubview:_quitBtns];
...
//        }
    ...
    [self.view addSubview:self.collectionViewCam];
    self.collectionViewCam.allowsMultipleExpandedSections = NO;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.item==0)
    {
        ...
        if (indexPath.section == 0)
        {
            ...
            cell.bgView.backgroundColor=UIColorFromRGB(0xFCB78D);
        ...
        else if(indexPath.section==1)
        {
            ...
            cell.bgView.backgroundColor=UIColorFromRGB(0xDDC48C);
        ...
        else if(indexPath.section==2)
        {
            ...
            cell.bgView.backgroundColor=UIColorFromRGB(0xCECA8D);
            cell.bgViewImg.hidden=YES;
...
//    if(indexPath.section==0)
//    {
//        return CGSizeMake((self.collectionViewCam.frame.size.width/6)-20, (self.collectionViewCam.frame.size.width/6)-20);
//    }
//    else
//    {
//      return CGSizeMake((self.collectionViewCam.frame.size.width/9)-20, (self.collectionViewCam.frame.size.width/9)-20);
//    }
//}
...
- (void)collectionView:(UICollectionView *)collectionView didCollapseItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.collectionViewCam reloadSections:index];
...
//    [self dismissViewControllerAnimated:true completion:nil];
    ...
    if ([self.delegate respondsToSelector:@selector(didCloseCamera)])
    {
        [self.delegate didCloseCamera];
    }
    }@catch(NSException *exception)
    {
...
//         [DemoUtils saveImage:image];
         ...
         if ([self.delegate respondsToSelector:@selector(didFinishedCamera:)])
         {
             [self.delegate didFinishedCamera:image];
         }
