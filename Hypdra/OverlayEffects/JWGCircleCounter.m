...
- (void)startWithSeconds:(NSInteger)seconds {
    ...
    if(_didStart==YES)
    //178,190,181
    self.circleBackgroundColor=[UIColor colorWithRed:139/255.0f green:135/255.0f blue:180/255.0f alpha:1];
    //139 135 180
...
- (void)timerCompleted {
    ...
    if(_didFinish==YES)
    {
        self.circleBackgroundColor=[UIColor colorWithRed:211/255.0f green:211/255.0f blue:211/255.0f alpha:0.8];
    }
