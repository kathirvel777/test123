 ...
 */
const CGFloat kCJMTabBarMaxButtonsOnScreen = 2;
/**
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < numberOfButtons; i++)
    {
        ...
        _CJMTabBarButton *btn = [[_CJMTabBarButton alloc] initWithFrame:CGRectMake(x, 0, buttonWidth, buttonHeight)];
...
- (void) NextTab:(NSNotification *) notification
{
    ...
    if (self.selectedIndex != tag)
    {
        ...
        if (self.selectedViewController.navigationController)
        {
            ...
            self.selectedViewController.navigationController.navigationBarHidden = NO;
        }
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // set title
        self.titleLabel.font = [UIFont fontWithName:@"Times New Roman" size:12.0f];
