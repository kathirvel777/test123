...
- (void)viewDidLoad
{
    ...
    if (self.immediateReturn) {
        ...
        [doneButtonItem setTitleTextAttributes:@{NSFontAttributeName:[UIFont fontWithName:@"FuturaT-Book" size:22.0],NSForegroundColorAttributeName:[UIColor whiteColor]} forState:UIControlStateNormal];
