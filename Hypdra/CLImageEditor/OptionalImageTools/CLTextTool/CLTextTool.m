...
- (void)setup
{
    ...
    _settingView.backgroundColor = UIColorFromRGB(0x262d32);
    ...
    for(NSDictionary *obj in _menu){
        ...
        switch (view.tag) {
            ...
            case 2:
                ...
                [_colorBtn.iconView setFrame:CGRectMake(_colorBtn.iconView.frame.origin.x, _colorBtn.iconView.frame.origin.y+10, _colorBtn.iconView.frame.size.width, _colorBtn.iconView.frame.size.width)];
