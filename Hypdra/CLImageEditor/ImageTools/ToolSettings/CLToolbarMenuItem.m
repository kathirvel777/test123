...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        if([[NSUserDefaults standardUserDefaults]boolForKey:@"isSmallIcon"]){
            _iconView = [[UIImageView alloc] initWithFrame:CGRectMake(10, 5, W-40, W-20)];
        }
        else{
        ...
        CGPoint center = CGPointMake(self.bounds.size.width/2, _iconView.center.y);
